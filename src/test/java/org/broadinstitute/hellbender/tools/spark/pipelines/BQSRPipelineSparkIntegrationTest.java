...
public class BQSRPipelineSparkIntegrationTest extends CommandLineProgramTest {
    ...
    public Object[][] createBQSRLocalRefTestData() {
        ...
        return new Object[][]{
                ...
                {new BQSRTest(b37_2bit_reference_20_21 , hiSeqBam_20_21_100000, more20Sites, " --joinStrategy BROADCAST -knownSites " + more21Sites, getResourceDir() + "expected.MultiSite.bqsr.pipeline.bam")},
        };
    }
