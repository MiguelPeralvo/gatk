...
public final class CollectInsertSizeMetricsCollectorSparkIntegrationTest extends CommandLineProgramTest{

    private static final File TEST_DATA_DIR = new File(getTestDataDir(), "picard/analysis/CollectInsertSizeMetrics");

    public String getTestedClassName() {
        return CollectInsertSizeMetricsCollectorSpark.class.getSimpleName();
    }
    ...
    public void test(final String fileName, final String referenceName) throws IOException {
        ...
        // some filter options
        args.add("-" + "E");
        args.add(TInsertSizeMetricsCollectorSparkArgs.EndToUse.SECOND);
