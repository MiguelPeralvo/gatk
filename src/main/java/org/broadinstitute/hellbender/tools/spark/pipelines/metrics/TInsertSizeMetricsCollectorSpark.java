...
//        JavaPairRDD<GroupMetaInfo, Tuple2<SamPairUtil.PairOrientation, Integer>> rdd2 = filteredReads.mapToPair(read -> traverseReadsToExtractInfo(read, header));
//        JavaPairRDD<GroupMetaInfo, Iterable<Tuple2<SamPairUtil.PairOrientation, Integer>>> rdd3 = rdd2.groupByKey();
//        JavaPairRDD<GroupMetaInfo, Map<SamPairUtil.PairOrientation, List<Integer>>> rdd4 = rdd3.mapToPair(InsertSizeMetricsCollectorSpark::gatherSizesByOrientation);
//        JavaPairRDD<GroupMetaInfo, Map<SamPairUtil.PairOrientation, SortedMap<Integer, Long>>> rdd5 = rdd4.mapToPair(InsertSizeMetricsCollectorSpark::constructHistogramFromList);
